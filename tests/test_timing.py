...
def test_estimate_remaining_at_min_progress():
    assert estimate_remaining(100.0, 0.05) == 1900.0


def test_estimate_remaining_negative_elapsed_clamped():
    assert estimate_remaining(-10.0, 0.25) == 0.0
