...
- **Agnes-native multimodal** — `agnes-3.0-flash` for scripting, `agnes-image-2.5-flash` for t2i and i2i consistency.
...
| `AGNES_CHAT_MODEL` | | `agnes-3.0-flash` | Text / tool-calling model ([docs](https://agnes-ai.com/en/docs/agnes-30-flash)). |
...
| `AGNES_IMAGE_I2I_MODEL` | | `agnes-image-2.5-flash` | Model used for consistency img2img. |
